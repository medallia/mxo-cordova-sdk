...
let Tab2Page = class Tab2Page {
    constructor() {
        this.products = ["Product 1B", "Product 2B", "Product 1C", "Product 2C"];
    }
    ionViewDidEnter() {
        var one = window.One;
        one.sendInteraction("/tab2", null, function (response) {
    ...
    onClick(product) {
        switch (product) {
            case "Product 1B": {
                one.sendInteraction("/tab2/product-1B-button", null, function (response) {
            ...
            case "Product 2B": {
                one.sendInteraction("/tab2/product-2B-button", null, function (response) {
            ...
            case "Product 1C": {
                one.sendInteraction("/tab2/product-1C-button", null, function (response) {
            ...
            case "Product 2C": {
                one.sendInteraction("/tab2/product-2C-button", null, function (response) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-title>\n      Product interest selector\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content [fullscreen]=\"true\">\n  <ion-header collapse=\"condense\">\n    <ion-toolbar>\n      <ion-title size=\"large\">Product interest selector</ion-title>\n    </ion-toolbar>\n  </ion-header>\n  <ion-list>\n    <ion-list>\n      <ion-item detail=\"false\" button *ngFor=\"let product of products\" (click)=\"onClick(product)\">\n          <ion-label>\n              {{ product }}\n          </ion-label>\n      </ion-item>\n    </ion-list>\n  </ion-list>\n</ion-content>\n");
